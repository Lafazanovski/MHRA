...
const EventsAgenda = () => {
  return (
    <>
      <div className="eventsAgendaSection">
        <div className="eventsAgendaContainer">
          <div className="eventsAgendaHeaderAndDateDiv">
            <h2>Агенда на настанот:</h2>
            <p>Четврток, 25 Јули, 2025</p>
          </div>
          <div className="eventsAgendaScheduleDiv">
            ...
            <div className="eventsAgendaTimeFrame">
              ...
              <div className="eventsAgendaTopic">
                ...
                <blockquote>
                  <li>
                    Презентер: <span>Елица Перчинкова</span>
                  </li>
                  <li>
            ...
            <div className="eventsAgendaTimeFrame">
              ...
              <div className="eventsAgendaTopic">
                ...
                <blockquote>
                  <li>
                    Модератор: <span>Ѓоко Вукановски</span>
                  </li>
                  <li>
            ...
            <div className="eventsAgendaTimeFrame">
              ...
              <div className="eventsAgendaTopic">
                <h3>Пауза за кафе и неформални разговори</h3>
              </div>
            </div>
            {/* Time and Topic */}
            <div className="eventsAgendaTimeFrame">
              ...
              <div className="eventsAgendaTopic">
                ...
                <blockquote>
                  <li>
                    Водител: <span>Зорица Поповска</span>
                  </li>
                  <li>
            ...
            <div className="eventsAgendaTimeFrame">
              ...
              <div className="eventsAgendaTopic">
                ...
                <blockquote>
                  <li>
                    Презентер: <span>Марија Петрушевска</span>
                  </li>
                  <li>
